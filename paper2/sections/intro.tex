...
bounded-step tracker can follow, and the option-implied signal we evaluated does not
anticipate it either. We report this as an honest boundary of the approach, with a
...
\item \textbf{The method.} A regime-conditional, panel-pooled, self-tuning
  ...
  numerical content we state honestly in Remark~\ref{rem:numeric}), plus
