...
RC (hand-tuned) & .898 & .899 & \textbf{.882} & \textbf{.941} & 1.70 & 2.26 \\
...
best marginal rates (5.02/1.07 against 5/1 budgets) and the highest
...
nominal 5\% and 1\%; DQ pass is the share of stocks passing the
dynamic-quantile test at the 99\% level.}
\label{tab:var}
\small
\begin{tabular}{lccc}
\toprule
 & 95\% stress breach & 99\% stress breach & 99\% DQ pass \\
\midrule
Normal (Gaussian) & 12.5\% & 6.7\% & .03 \\
FHS & 9.0\% & 2.7\% & .61 \\
GARCH-$t$ & 11.9\% & 4.1\% & .42 \\
CAViaR & 12.6\% & 5.4\% & .35 \\
ACI & 8.6\% & 3.1\% & .48 \\
RC (hand-tuned) & 5.6\% & 1.6\% & .70 \\
RC (adaptive) & \textbf{5.7\%} & \textbf{1.8\%} & \textbf{.72} \\
\bottomrule
\end{tabular}
\end{table}
...
native risk use. Wrapping Chronos's median with our layer flattens
coverage to $79.8 \pm 0.1\%$ in every regime
...
(.786 $\to$ .879) and the 2025 tariff shock up 9.9 (.765 $\to$ .864),
