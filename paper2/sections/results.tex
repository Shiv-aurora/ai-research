...
improves on ACI in stress by 0.1 points --- selecting similar days is not
the same as tracking a coverage target within a regime, which is why our
...
Table~\ref{tab:var} applies the one-sided head to next-day VaR and
...
coverage to $79.8 \pm 0.1\%$ in every regime. The repair is
...
(E9). RC improves the four worst episodes --- COVID by 9.3 points
(.786 $\to$ .879) and the 2025 tariff shock by 9.9 (.765 $\to$ .864) ---
...
conclusions are stable across $\alpha \in \{0.05, 0.10, 0.20\}$ (at
$\alpha = .05$: ACI stress .891 vs RC .932 against .95); and replacing
